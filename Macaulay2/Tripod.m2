...
"Auxiliary_files/Tripod_NonZeroEntries.txt" << toString nonZeroEntries << endl << close
...
"Auxiliary_files/Tripod_NonZeroPtilde.txt" << toString PTILDE << endl << close
...
"Auxiliary_files/TripodVanishingIdeal_ptilde.txt" << toString I << endl << close
"Auxiliary_files/TripodCI_ptilde.txt" << toString CI << endl << close
