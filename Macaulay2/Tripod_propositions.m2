...
nonZeroPtilde=value get "NonZeroPtilde.txt";
-- Retrieve indices of non-zero coordinates
nonZeroEntries=value get "NonZeroEntries.txt";
...
I=value get "TripodVanishingIdeal_ptilde.txt";
CI=value get "TripodCI_ptilde.txt";
